...
<head>
	...
	<!-- <script type="text/javascript" src="../assets/select2/select2.min.css"></script> -->
	
	<link href="../assets/select2/select2.min.css" rel="stylesheet" />
	<script type="text/javascript" src="../assets/select2/select2.min.js"></script>
    <!-- <link href="src=../assets/select2/select2.min.css" rel="stylesheet" /> -->
    <!-- <style type="text/css" src="src=../assets/select2/select2.min.css" rel="stylesheet"></style> -->
	<!-- <script type="text/javascript" src="../assets/select2/select2.min.js"></script> -->
		...
		<nav class="navbar navbar-inverse" style="border-radius: 0px">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php">LAUNDRY Malas Ngoding</a>
				</div>
