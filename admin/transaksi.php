...
<div class="container">
	<div class="panel">
		...
		<div class="panel-body">
			...
			<div class="form-group col-md-4 col-md-offset-8" style="padding-right: 0px;">
				<label for="search">Pencarian</label>
				<input type="text" name="search" id="search" class="form-control" placeholder="cari berdasarkan nama, status dll." onkeyup="sortirTransaksi(event)">
			</div>

			<div id="table-transaksi">	
